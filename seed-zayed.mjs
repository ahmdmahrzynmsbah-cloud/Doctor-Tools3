...
async function seed() {
  ...
  const transactions = [
    createInvoice(customerId, customer.name, "2026-06-18T10:00:00Z", 56500, [{ id: "temp", name: "رصيد مرحل (افتتاحي)", quantity: 1, sellPrice: 56500, total: 56500 }], true, "invoice"),
    createInvoice(customerId, customer.name, "2026-06-25T12:00:00Z", 10000, [], false, "payment"),
    ...
    createInvoice(customerId, customer.name, "2026-08-11T12:00:00Z", 5000, [], false, "payment"),
    createInvoice(customerId, customer.name, "2026-08-21T12:00:00Z", 5000, [], false, "payment"),
    createInvoice(customerId, customer.name, "2026-09-05T12:00:00Z", 5000, [], false, "payment"),
  ];
