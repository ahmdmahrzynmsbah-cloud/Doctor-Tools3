...
async function seed() {
  ...
  const transactions = [
    createInvoice(customerId, customer.name, "2026-06-18T10:00:00Z", 279500, [{ id: "temp", name: "رصيد مرحل (افتتاحي)", quantity: 1, sellPrice: 279500, total: 279500 }], true, "invoice"),
    createInvoice(customerId, customer.name, "2026-06-18T12:00:00Z", 2500, [], false, "payment"),
    createInvoice(customerId, customer.name, "2026-07-01T12:00:00Z", 2500, [], false, "payment"),
    createInvoice(customerId, customer.name, "2026-07-05T12:00:00Z", 2500, [], false, "payment"),
    createInvoice(customerId, customer.name, "2026-07-09T12:00:00Z", 2500, [], false, "payment"),
    createInvoice(customerId, customer.name, "2026-07-23T12:00:00Z", 2500, [], false, "payment"),
    createInvoice(customerId, customer.name, "2026-07-24T12:00:00Z", 2500, [], false, "payment"),
    createInvoice(customerId, customer.name, "2026-08-13T12:00:00Z", 5000, [], false, "payment"),
    createInvoice(customerId, customer.name, "2026-08-16T12:00:00Z", 2500, [], false, "payment"),
    createInvoice(customerId, customer.name, "2026-08-26T12:00:00Z", 2500, [], false, "payment"),
