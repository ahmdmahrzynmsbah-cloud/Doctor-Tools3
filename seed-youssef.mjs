...
async function seed() {
  ...
  const transactions = [
    createInvoice(customerId, customer.name, "2026-06-18T10:00:00Z", 19750, [{ id: "temp", name: "رصيد مرحل (افتتاحي)", quantity: 1, sellPrice: 19750, total: 19750 }], true, "invoice"),
    ...
    // 2026-07-04 SA-INV-1069 (22500 total)
    {
      id: crypto.randomUUID(),
      invoiceNumber: "SA-INV-1069",
      date: new Date("2026-07-04T10:00:00Z").toISOString(),
      customerId,
      items: [
         { id: crypto.randomUUID(), name: "كمبروسر 100 لتر نحاس (1) APT", quantity: 1, sellPrice: 22500, total: 22500 }
      ],
      total: 22500,
      paid: 0,
      ownerId: uid,
