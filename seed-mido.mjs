...
async function seed() {
  ...
  const transactions = [
    // 2026-08-04 SA-INV-1237 (3000 total, 1000 paid)
    {
      id: crypto.randomUUID(),
      invoiceNumber: "SA-INV-1237",
      date: new Date("2026-08-04T10:00:00Z").toISOString(),
      customerId,
      items: [
         { id: crypto.randomUUID(), name: "دريل هواء (1) 1300N", quantity: 1, sellPrice: 3000, total: 3000 }
      ],
      total: 3000,
      paid: 1000,
      ownerId: uid,
    ...
    // 2026-08-13 SA-INV-1251 (4500 total)
    {
      id: crypto.randomUUID(),
      invoiceNumber: "SA-INV-1251",
      date: new Date("2026-08-13T10:00:00Z").toISOString(),
      customerId,
      items: [
         { id: crypto.randomUUID(), name: "زرجينه سوست فتيل (1)", quantity: 1, sellPrice: 4500, total: 4500 }
      ],
      total: 4500,
      paid: 0,
      ownerId: uid,
    ...
    // 2026-08-16 SA-INV-1279 (800 total)
    {
      id: crypto.randomUUID(),
      invoiceNumber: "SA-INV-1279",
      date: new Date("2026-08-16T10:00:00Z").toISOString(),
      customerId,
      items: [
         { id: crypto.randomUUID(), name: "يد L 1/2 - بوصه", quantity: 2, sellPrice: 400, total: 800 }
      ],
      total: 800,
      paid: 0,
      ownerId: uid,
