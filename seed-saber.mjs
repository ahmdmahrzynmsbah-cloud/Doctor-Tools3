...
async function seed() {
  ...
  const transactions = [
    createInvoice(customerId, customer.name, "2026-06-18T10:00:00Z", 15000, [{ id: "temp", name: "رصيد مرحل (افتتاحي)", quantity: 1, sellPrice: 15000, total: 15000 }], true, "invoice"),
    createInvoice(customerId, customer.name, "2026-06-21T12:00:00Z", 3000, [], false, "payment"),
    
    // 2026-07-01 SA-INV-1039 (38500 total)
    {
      id: crypto.randomUUID(),
      invoiceNumber: "SA-INV-1039",
      date: new Date("2026-07-01T10:00:00Z").toISOString(),
      customerId,
      items: [
         { id: crypto.randomUUID(), name: "تكييف 2.25 حصان كارير", quantity: 1, sellPrice: 38500, total: 38500 }
      ],
      total: 38500,
      paid: 0,
      ownerId: uid,
    ...
    createInvoice(customerId, customer.name, "2026-07-01T12:00:00Z", 7000, [], false, "payment"),
    createInvoice(customerId, customer.name, "2026-07-23T12:00:00Z", 5000, [], false, "payment"),
    createInvoice(customerId, customer.name, "2026-07-30T10:00:00Z", 10000, [], false, "payment"),
    
    // 2026-07-30 SA-INV-1193 (14000 total)
    {
      id: crypto.randomUUID(),
      invoiceNumber: "SA-INV-1193",
      date: new Date("2026-07-30T14:00:00Z").toISOString(),
      customerId,
      items: [
         { id: crypto.randomUUID(), name: "طقم لقم 199 قطعه", quantity: 2, sellPrice: 7000, total: 14000 }
      ],
      total: 14000,
      paid: 0,
      ownerId: uid,
      createdAt: new Date("2026-07-30T14:00:00Z").getTime(),
      updatedAt: new Date("2026-07-30T14:00:00Z").getTime()
    },
    
    createInvoice(customerId, customer.name, "2026-08-04T12:00:00Z", 10000, [], false, "payment"),
    
    // 2026-08-16 SA-INV-1282 (6500 total)
    {
      id: crypto.randomUUID(),
      invoiceNumber: "SA-INV-1282",
      date: new Date("2026-08-16T10:00:00Z").toISOString(),
      customerId,
      items: [
         { id: crypto.randomUUID(), name: "دريل بطاريه APT -4A- 800N", quantity: 1, sellPrice: 6500, total: 6500 }
      ],
      total: 6500,
      paid: 0,
      ownerId: uid,
    ...
    // 2026-08-20 SA-INV-1319 (87500 total)
    {
      id: crypto.randomUUID(),
      invoiceNumber: "SA-INV-1319",
      date: new Date("2026-08-20T10:00:00Z").toISOString(),
      customerId,
      items: [
         { id: crypto.randomUUID(), name: "كوريك 2 عمود وصله سفلي 4طن 2D", quantity: 1, sellPrice: 87500, total: 87500 }
      ],
      total: 87500,
      paid: 0,
      ownerId: uid,
